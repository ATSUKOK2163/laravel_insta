...
@section('content')
    <form action="{{ route('admin.categories.store') }}" method="post">
        ...
        <div class="row gx-2 mb-4">
            <div class="col-4">
                <input type="text" class="form-control" placeholder="Add a category..." name="name" autofocus>
            </div> 
            <div class="col-auto">
        ...
        <div class="col-7">
            <table class="table table-hover align-middle bg-white border table-sm text-secondary text-center">
                ...
                <tbody>
                    ...
                    @empty
                            <tr colspan="5" class="lead text-muted text-center">No categories found.</tr>
                    @endforelse
