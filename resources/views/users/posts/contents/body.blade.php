...
<div class="card-body">
    ...
    <div class="row align-items-center">
        ...
        <div class="col text-end">
            @forelse ($post->categoryPost as $category_post)
                <span class="badge br-secondary bg-opacity-50">{{ $category_post->category->name }}</span>
            @empty
    ...
    {{-- owner + description --}}
    <a href="{{ route('profile.show', $post->user->id) }}" class="text-decoration-nonw text-dark fw-bold">{{ $post->user->name}}</a>
    &nbsp;
